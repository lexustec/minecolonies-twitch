...
public abstract class AbstractConfigTwitch
{
    ...
    protected static ForgeConfigSpec.DoubleValue defineDouble(final ForgeConfigSpec.Builder builder, final String key, final double defaultValue, final double min, final double max)
    {
        return buildBase(builder, key).defineInRange(key, defaultValue, min, max);
    }

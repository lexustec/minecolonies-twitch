...
public class TileEntityTwitch extends TileEntityColonyBuilding implements ITickableTileEntity
{
     ...
     */
    public TileEntityTwitch()
    {
        this(MinecoloniesTwitchEntities.TWITCHBUILDING);
    }

    /**
     * Alternative overriden constructor.
     */
    public TileEntityTwitch(final TileEntityType type)
    {
        super(type);
    }

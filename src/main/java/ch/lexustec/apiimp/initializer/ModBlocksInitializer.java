...
public final class ModBlocksInitializer
{
    ...
    {
        Log.getLogger().info("ModBlocks Init registerBlocks");
        ModBlocks.blockHutTwitch = new BlockHutTwitch().registerBlock(registry);
    ...
    {
        Log.getLogger().info("registerBlockItem");
        final Item.Properties properties = new Item.Properties().group(ModCreativeTabs.MINECOLONIES);
        ModBlocks.blockHutTwitch.registerBlockItem(registry, properties);
        //
